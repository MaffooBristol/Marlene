(function() {
  var argv, clc, crypto, db, dbRecord, emphasise, error, fs, moment, notice, os, phrases, rollbar, secrets, skip, twitter, util, warn, yaml, _phrases;
        ...
        switch (argv.method) {
          ...
          case 'observe':
            ...
            return _self.userStream.on('tweet', function(tweet) {
              var i, j, k, _i, _j, _k, _len, _len1, _output, _ref, _ref1, _ref2, _text;
